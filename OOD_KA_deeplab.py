...
from OOD_KA_amal_deeplab import OOD_KA_Amalgamator_DeepLab
...
def main():
    ...
    # ==================== Trainer =====================
    # ==================================================
    output_dir = 'run/OOD_KA_deeplab_%s' % (time.asctime().replace(' ', '_'))
    trainer = OOD_KA_Amalgamator_DeepLab(
        logger=get_logger(name='OOD-KA-deeplab', output=os.path.join(output_dir, 'log.txt')),
