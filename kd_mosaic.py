...
def main_worker(gpu, ngpus_per_node, args):
    ...
    ood_dataset.transforms = ood_dataset.transform = ori_dataset.transform # w/ augmentation
    train_dataset.transforms = train_dataset.transform = val_dataset.transform # w/o augmentation
